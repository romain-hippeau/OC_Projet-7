      ...
      <div class="register">
          <div class="container">
             ...
             <img class="logo-group" src="../assets/icon-blanc.png" alt="" srcset="">
              <p>Si vous n'etes pas connecter , veillez creer un compte</p>
              <button><router-link to="/register">register</router-link> <i class="fas fa-arrow-circle-right"></i></button>
          </div>
      </div>  
    </div>
</template>
